package com.wnotice.libworkthreex.lib.Compress;
...
//static InputStream UpZip(String zipFileString, String fileString)
// 
...
//static void UnZipFolder(String zipFileString, String outPathString)
// 
//解压一个压缩文档 到指定位置
//zipFileString    : 压缩包文件
...
//static void ZipFolder(String srcFileString, String zipFileString)
// 
//压缩文件,文件夹
...
public class XZip {
    ...
    public static void UnZipFolder(String zipFileString, String outPathString)throws Exception {  
        ...
        while ((zipEntry = inZip.getNextEntry()) != null) {  
            ...
            if (zipEntry.isDirectory()) {  
                ...
                // get the folder name of the widget  
                szName = szName.substring(0, szName.length() - 1);  
                //android.util.Log.v("folder:", outPathString + java.io.File.separator + szName);  
    ...
    public static void ZipFolder(String basePath,String srcFileString, String zipFileString)throws Exception {   
    	try{
    		String separator = basePath.substring(basePath.length() - 1);  
        	if(basePath.substring(basePath.length() - 1).equals(java.io.File.separator)){
        		ZipFolder(basePath+srcFileString,  zipFileString);
        		return;
        	}
    	}catch(Exception e){
    		
    	}    	
    	ZipFolder(basePath+java.io.File.separator+srcFileString,  zipFileString);
    }
    /** 
     * 压缩文件 
     * @param folderString 
